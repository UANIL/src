...
bitcoin_address_file = io.open('bitcoin_address.csv', 'w')
bitcoin_address_link_file = io.open('bitcoin_address_link.csv', 'w')
category_file = io.open('category.csv', 'w')
category_link_file = io.open('category_link.csv', 'w')
categorylink_file = io.open('categorylink.csv', 'w')
clone_group_file = io.open('clone_group.csv', 'w')
daily_stat_file = io.open('daily_stat.csv', 'w')
domain_file = io.open('domain.csv', 'w')
email_file = io.open('email.csv', 'w')
email_link_file = io.open('email_link.csv', 'w')
headless_bot_file = io.open('headless_bot.csv', 'w')
headlessbot_file = io.open('headlessbot.csv', 'w')
open_port_file = io.open('open_port.csv', 'w')
page_file = io.open('page.csv', 'w')
page_link_file = io.open('page_link.csv', 'w')
request_log_file = io.open('request_log.csv', 'w')
search_log_file = io.open('search_log.csv', 'w')
ssh_fingerprint_file = io.open('ssh_fingerprint.csv', 'w')
web_component_file = io.open('web_component.csv', 'w')
web_component_link_file = io.open('web_component_link.csv', 'w')
